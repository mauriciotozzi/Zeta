=============  LEIAME VS GESTOR_Z_20.0.X  =======================
	
	* NOVA VERSÃO COM AS ALTERAÇÕES DA REFORMA TRIBUTÁRIA
	
	- MODULO DE NF-e Ok, GERANDO NOVO ARQUIVO CONFORME LAYOUT
	- TELA Ok, COM OS PRINCIPAIS CAMPOS
		- MONOFÁSICO E ESPECIAIS EM ANDAMENTO	
	-CRUD EM ANDAMENTO
		- CAMPOS A SEREM ADICIONADOS EM BANCO DE DADOS
...
=============  LEIAME VS GESTOR_Z_19.6.X  =======================
	...
	* MELHORIA EM RECEBIMENTO DE NOTA, PERMITINDO ALTERAÇÃO NO CONTAS A PAGAR DIRETAMENTE
